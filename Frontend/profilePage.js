...
function validateAndSave(event) {
    ...
    //let phoneNumber = document.getElementById("phoneNumberInput").textContent;
    //console.log("got phone number: " + phoneNumber);
    let username = document.getElementById("usernameInput").textContent;
    let phoneNumber = document.getElementById("phoneNumberInput").textContent;
    let age = document.getElementById("ageInput").textContent;
    let bio = document.getElementById("bioInput").textContent;
...
function generateProfilePage(changePage) {
    ...
    mainForm.addEventListener("submit", validateAndSave); //tells the form to call validateAndSave when submit is clicked.
