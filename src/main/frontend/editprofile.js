 ...
 */
function generateEditProfilePage(changePage) {
    ...
    mainForm.addEventListener("submit", (event) => {if (validateAndSave()) changePage("match")}); //tells the form to call validateAndSave when submit is clicked.
    ...
    skillLevelLabel.textContent = "Select your skill level (on a scale from 1-5):";
    ...
    backButton.onclick = () => changePage("match");
...
export { generateEditProfilePage };